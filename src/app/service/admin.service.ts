...
export class AdminService {
  ...
  actualizar_estado_cliente(id: string, activo: boolean, token: any): Observable<any> {
  ...
  obtener_skus(token: any): Observable<any> {
    let headers = new HttpHeaders({'Authorization': token});
    return this._http.get(this.url + 'obtener_skus', {headers: headers});
  }
